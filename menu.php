...
var categoryId = 0;
$(function() {
	fetchProducts(menuId,null);
});
//fetch products by filter options
function fetchProducts(menuId,queryParams) {
	$.ajax({
		type: "POST",
		url: "./php/fetch_menu_products.php",
		dataType: 'html',
		data : {'queryParams':queryParams,'menuId':menuId},
...
$(document).on('click', '.filterItem', function () {
	...
	fetchProducts(menuId,queryParams);
});
